# <h3> Desafio - Aula de backend via youtube

Treinamento de teste backend de cypress
```
Site utilizado: https://fakerestapi.azurewebsites.net/api/v1/
```
## <h3> 📃 Funcionalidades abordadas
```
Validação de dados conforme aula passada
```
...
a pasta a ser aberta no VScode deve ter o nome de "Aula_backend"
```
